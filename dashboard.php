...
<head>
    ...
    <title>Tableau de Bord  gestion Pharmacie</title>
...
<body>
    ...
    <section id="content">
        ...
        <div class="widget">
            ...
            <p>
                Chiffre d'affaire du jour : <span class="highlight"><?php echo $_SESSION['chiffreAffaireJ']." MAD"; ?></span>
            </p>
        </div>
        
        <div class="widget" id="widgetChiffre">
            <h2 id="chiffreAffaire">Chiffre d'Affaire</h2>
            <p id="chiffreAffaireP"><?php echo $_SESSION['chiffreAffaire']." MAD"; ?></p>
        </div>
    ...
    <section class="tableau">
       ...
       <tbody>
            <tr>
                ...
                <td><?php echo $vente['prix_unit']."MAD"; ?></td>
        ...
        <tfoot>
            ...
            <td colspan="2" style="color: #0091ff;"><?php echo $_SESSION['chiffreAffaireJ']." MAD"; ?></td>
        </tfoot>
